...
def registrar_alerta_af(linha):
    ...
    registro.update({
        ...
        "novos_chutes_gol": linha.get("novos_chutes_gol", ""),
        "novos_escanteios": linha.get("novos_escanteios", ""),
        "novas_finalizacoes": linha.get("novas_finalizacoes", ""),
        "elegivel_v2_sombra": linha.get("elegivel_v2_sombra", ""),
